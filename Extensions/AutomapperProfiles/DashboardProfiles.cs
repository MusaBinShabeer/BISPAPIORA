    ...
    public class DashboardProfiles : Profile
    {
        ...
        public DashboardProfiles()
        {
            CreateMap<tbl_citizen, DashboardCitizenBaseModel>()
                ...
                .ForMember(d => d.user_name, opt => opt.MapFrom(src => src.tbl_citizen_registration != null ? src.tbl_citizen_registration.registered_by.user_email : src.tbl_enrollment != null ? src.tbl_enrollment.enrolled_by.user_email : ""))
