    ...
    public class CitizenBankInfoProfile : Profile
    {
        ...
        public CitizenBankInfoProfile()
        {
            ...
            CreateMap<UpdateRegistrationDTO, AddRegisteredCitizenBankInfoDTO>()
             ...
             .ForMember(d => d.fkCitizen, opt => opt.MapFrom(src => src.fkCitizen))
             .ForMember(d => d.fkBank, opt => opt.MapFrom(src => src.fkBank));
            CreateMap<AddRegisteredCitizenBankInfoDTO, tbl_citizen_family_bank_info>()
            ...
            .ForMember(d => d.family_income, opt => opt.MapFrom(src => src.aIOA))
            ...
            .ForMember(d => d.fk_citizen, opt => opt.MapFrom(src => src.fkCitizen))
            .ForMember(d => d.fk_bank, opt => opt.MapFrom(src => src.fkBank));
            CreateMap<UpdateRegisteredCitizenBankInfoDTO, tbl_citizen_family_bank_info>()
            ...
            .ForMember(d => d.family_income, opt => opt.MapFrom((src, dest) => otherServices.Check(src.aIOA) ? decimal.Parse(src.aIOA.ToString()) : dest.family_income))
            ...
            CreateMap<tbl_citizen_family_bank_info, RegisteredCitizenBankInfoResponseDTO>()
            ...
            .ForMember(d => d.aIOA, opt => opt.MapFrom((src) => src.family_income))
           ...
           .ForMember(d => d.fkCitizen, opt => opt.MapFrom(src => src.fkCitizen))
           .ForMember(d => d.fkBank, opt => opt.MapFrom(src => src.fkBank));
            CreateMap<AddEnrollmentDTO, UpdateEnrolledCitizenBankInfoDTO>()
           .ForMember(d => d.ibanNo, opt => opt.MapFrom(src => src.ibanNo))
           .ForMember(d => d.accountType, opt => opt.MapFrom(src => src.accountType))
           .ForMember(d => d.fkCitizen, opt => opt.MapFrom(src => src.fkCitizen))
           .ForMember(d => d.fkBank, opt => opt.MapFrom(src => src.fkBank));
            CreateMap<UpdateEnrolledCitizenBankInfoDTO, AddEnrolledCitizenBankInfoDTO>()
           .ForMember(d => d.ibanNo, opt => opt.MapFrom(src => src.ibanNo))
           .ForMember(d => d.accountType, opt => opt.MapFrom(src => src.accountType))
           .ForMember(d => d.fkCitizen, opt => opt.MapFrom(src => src.fkCitizen))
           .ForMember(d => d.fkBank, opt => opt.MapFrom(src => src.fkBank));
