    ...
    public class CitizenProfile : Profile
    {
        ...
        public CitizenProfile()
        {
            ...
            CreateMap<tbl_registration, RegistrationResponseDTO>()
             ...
             .ForMember(d => d.citizenCode, opt => opt.MapFrom(src => src.citizen_code))
             ...
             .ForMember(d => d.bankName, opt => opt.MapFrom((src) =>src.tbl_citizen.tbl_bank_other_specification!=null?src.tbl_citizen.tbl_bank_other_specification.bank_other_specification :src.tbl_citizen.tbl_citizen_bank_info.tbl_bank.bank_name));
            ...
            .ForMember(d => d.citizenCode, opt => opt.MapFrom(src => src.code))
            ...
            .ForMember(d => d.bankName, opt => opt.MapFrom((src) => src.tbl_bank_other_specification != null ? src.tbl_bank_other_specification.bank_other_specification : src.tbl_citizen_bank_info.tbl_bank.bank_name));
            #endregion
            ...
            CreateMap<tbl_enrollment, EnrollmentResponseDTO>()
             ...
             .ForMember(d => d.citizenCode, opt => opt.MapFrom(src => src.citizen_code))
             .ForMember(d => d.citizenName, opt => opt.MapFrom(src => src.tbl_citizen.citizen_name))
             .ForMember(d => d.enrolledDate, opt => opt.MapFrom(src => src.tbl_citizen.enrolled_date))
