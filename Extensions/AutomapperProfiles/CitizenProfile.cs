    ...
    public class CitizenProfile : Profile
    {
        ...
        public CitizenProfile()
        {
            ...
            CreateMap<UpdateRegistrationDTO, tbl_citizen>()
             ...
             .ForMember(d => d.citizen_employement, opt => opt.MapFrom((src, dest) => otherServices.Check(src.fkEmployment) ? Guid.Parse(src.fkEmployment) : dest.fk_citizen_employment))
            ...
            CreateMap<tbl_registration, RegistrationResponseDTO>()
             ...
             .ForMember(d => d.tehsilName, opt => opt.MapFrom(src => src.tbl_citizen.citizen_tehsil != null ? src.tbl_citizen.citizen_tehsil.tehsil_name : ""))
             .ForMember(d => d.districtName, opt => opt.MapFrom(src => src.tbl_citizen.citizen_tehsil != null ? src.tbl_citizen.citizen_tehsil.tbl_district.district_name : ""))
             .ForMember(d => d.provinceName, opt => opt.MapFrom(src => src.tbl_citizen.citizen_tehsil != null ? src.tbl_citizen.citizen_tehsil.tbl_district.tbl_province.province_name : ""))
             .ForMember(d => d.tehsilName, opt => opt.MapFrom(src => src.tbl_citizen.citizen_tehsil != null ? src.tbl_citizen.citizen_tehsil.tehsil_name : ""))
             .ForMember(d => d.fkEmployment, opt => opt.MapFrom(src => src.tbl_citizen.fk_citizen_employment))
             .ForMember(d => d.employmentName, opt => opt.MapFrom(src => src.tbl_citizen.citizen_employement != null ? src.tbl_citizen.citizen_employement.employment_name : ""))
             .ForMember(d => d.fkEducation, opt => opt.MapFrom(src => src.tbl_citizen.fk_citizen_education))
             .ForMember(d => d.educationName, opt => opt.MapFrom(src => src.tbl_citizen.citizen_education != null ? src.tbl_citizen.citizen_education.education_name : ""))
            ...
            .ForMember(d => d.tehsilName, opt => opt.MapFrom(src => src.citizen_tehsil != null ? src.citizen_tehsil.tehsil_name : ""))
            .ForMember(d => d.districtName, opt => opt.MapFrom(src => src.citizen_tehsil != null ? src.citizen_tehsil.tbl_district.district_name : ""))
            .ForMember(d => d.provinceName, opt => opt.MapFrom(src => src.citizen_tehsil != null ? src.citizen_tehsil.tbl_district.tbl_province.province_name : ""))
            .ForMember(d => d.fkEmployment, opt => opt.MapFrom(src => src.fk_citizen_employment))
            .ForMember(d => d.employmentName, opt => opt.MapFrom(src => src.citizen_employement != null ? src.citizen_employement.employment_name : ""))
            .ForMember(d => d.fkEducation, opt => opt.MapFrom(src => src.fk_citizen_education))
            .ForMember(d => d.educationName, opt => opt.MapFrom(src => src.citizen_education != null ? src.citizen_education.education_name : ""))
