    ...
    public class CitizenProfile : Profile
    {
        ...
        public CitizenProfile()
        {
            ...
            CreateMap<AddEnrollmentDTO, UpdateEnrollmentDTO>()
              ...
              .ForMember(d => d.citizenGender, opt => opt.MapFrom(src => $"{(GenderEnum)src.citizenGender}"))
              .ForMember(d => d.maritalStatus, opt => opt.MapFrom(src => $"{(MartialStatusEnum)src.maritalStatus}"))
              ...
              .ForMember(d => d.fkTehsil, opt => opt.MapFrom(src => src.fkTehsil))
              .ForMember(d => d.fkEmployment, opt => opt.MapFrom(src => src.fkEmployment))
              .ForMember(d => d.fkEducation, opt => opt.MapFrom(src => src.fkEducation))
              ...
              .ForMember(d => d.uniHHId, opt => opt.MapFrom(src => !string.IsNullOrEmpty(src.uniHHId) ? decimal.Parse(src.uniHHId) : default!))
              .ForMember(d => d.pmt, opt => opt.MapFrom(src => (!string.IsNullOrEmpty(src.pmt) ? src.pmt : "")))
              .ForMember(d => d.submissionDate, opt => opt.MapFrom(src => !string.IsNullOrEmpty(src.submissionDate) ? DateTime.Parse(src.submissionDate) : default!))
              .ForMember(d => d.isValidBeneficiary, opt => opt.MapFrom((src, dest) => (dest.isValidBeneficiary)));
            ...
            CreateMap<tbl_enrollment, EnrollmentResponseDTO>()
             ...
             .ForMember(d => d.fatherSpouseName, opt => opt.MapFrom(src => src.tbl_citizen.citizen_father_spouce_name))
             .ForMember(d => d.citizenPhoneNo, opt => opt.MapFrom(src => src.tbl_citizen.citizen_phone_no))
             ...
             .ForMember(d => d.BankName, opt => opt.MapFrom((src) => src.tbl_citizen_bank_info != null ? src.tbl_citizen_bank_info.tbl_bank.bank_name:"" ))
             .ForMember(d => d.citizenBankOtherSpecification, opt => opt.MapFrom((src) => src.tbl_citizen_bank_info.tbl_bank_other_specification != null ? src.tbl_citizen_bank_info.tbl_bank_other_specification.bank_other_specification : ""))
             ...
             .ForMember(d => d.citizenEmploymentOtherSpecification, opt => opt.MapFrom(src => src.tbl_employment_other_specification != null ? src.tbl_employment_other_specification.employment_other_specification : ""))
             .ForMember(d => d.fkEducation, opt => opt.MapFrom(src => src.fk_citizen_education))
             .ForMember(d => d.educationName, opt => opt.MapFrom(src => src.tbl_citizen_education != null ? src.tbl_citizen_education.education_name : ""))
             .ForMember(d => d.uniHHId, opt => opt.MapFrom(src => (src.unique_hh_id).ToString()))
             .ForMember(d => d.pmt, opt => opt.MapFrom(src => (src.pmt)))
             .ForMember(d => d.submissionDate, opt => opt.MapFrom(src => (src.submission_date).ToString()))
             .ForMember(d => d.isValidBeneficiary, opt => opt.MapFrom(src => (src.is_valid_beneficiary)));
            CreateMap<tbl_citizen, EnrollmentSchemeResponseDTO>()
            .ForMember(d => d.enrollmentId, opt => opt.MapFrom(src => src.tbl_enrollment != null ? src.tbl_enrollment.enrollment_id.ToString() : ""))
            .ForMember(d => d.citizenId, opt => opt.MapFrom(src => src.citizen_id))
            .ForMember(d => d.citizenCode, opt => opt.MapFrom(src => src.id))
            .ForMember(d => d.citizenName, opt => opt.MapFrom(src => src.citizen_name))
            ...
            CreateMap<tbl_citizen, CitizenResponseDTO>()
              ...
              .ForMember(d => d.bankName, opt => opt.MapFrom((src) => src.tbl_citizen_family_bank_info!=null?src.tbl_citizen_family_bank_info.tbl_bank.bank_name:""))
              .ForMember(d => d.citizenFamilyBankOtherSpecification, opt => opt.MapFrom((src) => src.tbl_citizen_family_bank_info!=null?src.tbl_citizen_family_bank_info.tbl_bank.bank_name:""))
              .ForMember(d => d.citizenBankName, opt => opt.MapFrom((src) => src.tbl_citizen_bank_info!=null?src.tbl_citizen_bank_info.tbl_bank.bank_name:""))
              .ForMember(d => d.citizenBankOtherSpecification, opt => opt.MapFrom((src) => src.tbl_citizen_bank_info.tbl_bank_other_specification!=null?src.tbl_citizen_bank_info.tbl_bank_other_specification.bank_other_specification:""))
              .ForMember(d => d.uniHHId, opt => opt.MapFrom(src => (src.unique_hh_id).ToString()))
              .ForMember(d => d.pmt, opt => opt.MapFrom(src => (src.pmt)))
