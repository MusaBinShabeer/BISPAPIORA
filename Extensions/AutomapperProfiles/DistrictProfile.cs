    ...
    public class DistrictProfile : Profile
    {
        ...
        public DistrictProfile()
        {
            CreateMap<AddDistrictDTO, tbl_district>()
             ...
             .ForMember(d => d.province_code, opt => opt.MapFrom(src => src.provinceCode))
            ...
            CreateMap<UpdateDistrictDTO, tbl_district>()
             ...
             .ForMember(d => d.province_code, opt => opt.MapFrom((src, dest) => otherServices.Check(src.provinceCode) ? src.provinceCode : dest.province_code))
            ...
            .ForMember(d => d.provinceCode, opt => opt.MapFrom((src) => src.province_code))
