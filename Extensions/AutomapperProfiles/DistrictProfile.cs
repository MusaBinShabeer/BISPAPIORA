    ...
    public class DistrictProfile : Profile
    {
        ...
        public DistrictProfile()
        {
            CreateMap<AddDistrictDTO, tbl_district>()
             ...
             .ForMember(d => d.province_id, opt => opt.MapFrom(src => src.provinceId))
            ...
            CreateMap<UpdateDistrictDTO, tbl_district>()
             ...
             .ForMember(d => d.province_id, opt => opt.MapFrom((src, dest) => otherServices.Check(src.provinceId) ? src.provinceId : dest.province_id))
