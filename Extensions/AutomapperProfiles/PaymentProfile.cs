    ...
    public class PaymentProfile : Profile
    {
        ...
        public PaymentProfile()
        {
            CreateMap<AddPaymentDTO, tbl_payment>()
             ...
             .ForMember(d => d.actual_due_amount, opt => opt.MapFrom(src => src.actualDueAmount))
             .ForMember(d => d.quarterly_due_amount, opt => opt.MapFrom(src => src.quarterlyDueAmount))
            ...
            CreateMap<UpdatePaymentDTO, tbl_payment>()
             ...
             .ForMember(d => d.actual_due_amount, opt => opt.MapFrom((src, dest) => otherServices.Check(src.actualDueAmount) ? decimal.Parse(src.actualDueAmount.ToString()) : dest.actual_due_amount))
             .ForMember(d => d.quarterly_due_amount, opt => opt.MapFrom((src, dest) => otherServices.Check(src.quarterlyDueAmount) ? decimal.Parse(src.quarterlyDueAmount.ToString()) : dest.quarterly_due_amount))
            ...
            CreateMap<tbl_payment, PaymentResponseDTO>()
             ...
             .ForMember(d => d.actualDueAmount, opt => opt.MapFrom((src) => src.actual_due_amount))
             .ForMember(d => d.quarterlyDueAmount, opt => opt.MapFrom((src) => src.quarterly_due_amount))
