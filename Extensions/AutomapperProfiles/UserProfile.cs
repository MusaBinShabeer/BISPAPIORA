    ...
    public class UserProfile : Profile
    {
        ...
        public UserProfile()
        {
            CreateMap<AddUserDTO, tbl_user>()
             ...
             .ForMember(d => d.user_password, opt => opt.MapFrom(src => src.userPassword))
            ...
            CreateMap<UpdateUserDTO, tbl_user>()
             ...
             .ForMember(d => d.user_password, opt => opt.MapFrom((src, dest) => otherServices.Check(src.userPassword) ? src.userPassword : dest.user_password))
